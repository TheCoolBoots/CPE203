...
public class TestCases {
	...
	public void testImplSpecifics() throws NoSuchMethodException {
		...
		final List<Class> expectedMethodReturns = Arrays.asList(double.class, double.class, double.class, double.class,
				Point.class);
	...
	private static void verifyImplSpecifics(final Class<?> clazz, final List<String> expectedMethodNames,
		...
		final List<Field> nonFinalFields = Arrays.stream(clazz.getDeclaredFields())
	...
	public void testRadius() {
		...
		assertTrue(Math.sqrt(2) == p.getRadius());
	}
	
	@Test
	public void testGetAngle() {
		Point p = new Point(1,0);
		assertTrue(0.0 == p.getAngle());
	}
	
	@Test
	public void testRotate() {
		Point p = new Point(1,2);
		Point rotate = p.rotate90();
		assertTrue( rotate.getX() == 2 && rotate.getY() == -1 );
	}
}
