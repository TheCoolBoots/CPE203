...
final class WorldModel {
	...
	private static final double PERCENT_BLITZ = .4;
	...
	public boolean parseMiner(String[] properties, ImageStore imageStore) {
		if (properties.length == MINER_NUM_PROPERTIES) {
			...
			Entity entity = pt.createMinerNotFull(properties[MINER_ID], Integer.parseInt(properties[MINER_LIMIT]),
					...
					Integer.parseInt(properties[MINER_ANIMATION_PERIOD]), imageStore.getImageList("miner")); //imageStore.getImageList(MINER_KEY));
			tryAddEntity(entity);
		}
